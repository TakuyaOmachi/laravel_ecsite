                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            <h1 class="mb-4 text-sm title-font text-gray-500 tracking-widest">{{ $product->category->name }}</h1>
                            <h2 class="mb-4 text-gray-900 text-2xl title-font font-medium">{{ $product->name }}</h2>
                    ...
                    <div class="mb-4 text-center">
                        @if ($product->shop->filename !== null)
                            <img class="mx-auto h-40 w-40 rounded-full object-covor" src="{{ asset('storage/shops/' . $product->shop->filename)}}" alt="">
                        @else
                            <img src="">
                        @endif
                    </div>
                    <div class="mb-4 text-center">
                        <button type="button" data-micromodal-trigger="modal-1" href="javascript:;" class="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
